...
a = 3;
wind = 525;
% activeRange = wind*(a-1)+1:1:wind*a;
activeRange = 1560:1:wind*a;
...
for k = 1:mpc_steps
    ...
    p = reshape(attitude_schedule_(:,att_index),np*(predictHolizon+1),1);
    ...
    for l = 1:simEx
        ...
        q_rtn2body = quaternion(attitude_schedule_(1:4,kk+1)');
...
index_end(i) = index_end_;
attitude_schedule(:,:,i) = attitude_schedule_;
end

save("log/"+DateString+".mat", "state_log", "input_log","constraint_log", "index_end", "attitude_schedule");
