f =figure('Name',"Trajectory : " + j,'Units','centimeters', 'Position',[0 0 10 11],'Color','white');
...
legend([p, p7, b],["Trajectory $(l=1,\cdots, 6)$", "Trajectory $(l=7)$" "KOZ"],"Location","northoutside","Interpreter","latex");
xlim([-31 31])
ylim([-31 31])
daspect([1 1 1])
fontsize(12,"points")
