...
f = figure('unit','centimeter','Position', [0 0 17 6.5],'Color','white');
i = 1;
rhoRow = rho(:,:,j);
pathRow = path(:,:,j);
...
p = plot3(pathXYZ(1,1:i), pathXYZ(3,1:i),pathXYZ(2,1:i), "LineStyle", "-",Color="k");
r = scatter3(pathXYZ(1,i), pathXYZ(3,i),pathXYZ(2,i), 10,"filled","o","MarkerFaceColor","k",MarkerEdgeColor = "k");
legend([b, p], ["KOZ", "Trajecory"], "NumColumns", 1, "Interpreter", "latex","Position",[0.17 0.7, 0.2, 0.2]);
daspect([1,1,1])
fontsize(12,"points")
xlabel('$x$ [m]', 'Interpreter', 'latex')
ylabel('$z$ [m]', 'Interpreter', 'latex')
